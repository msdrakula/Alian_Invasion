...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Создаение экземпляров для хранения статистики и панели результатов
    ...
    def _check_play_button(self, mouse_pos):
        """Запустить новую игру при нажатии кнопки play"""
    ...
    def _update_aliens(self):
        """Проверяет, достиг ли флот края экрана, с последующим обновлением позиции всех пришельцев во флоте"""
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            #Уменьшается ships_left и обновление панели счета
